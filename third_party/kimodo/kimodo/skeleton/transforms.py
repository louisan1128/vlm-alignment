...
def global_rots_to_local_rots(global_joint_rots: torch.Tensor, skeleton):
    ...
    """
    # Modified for VLM Alignment v2: flatten and restore leading dimensions
    # directly, avoiding the optional einops dependency.
    original_shape = global_joint_rots.shape
    global_joint_mats = global_joint_rots.reshape(-1, *original_shape[-3:])
    ...
    return local_rot_mats.reshape(original_shape)
